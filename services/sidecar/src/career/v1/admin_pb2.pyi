...
class GateRow(_message.Message):
    __slots__ = ("criterion", "value", "target", "as_of", "detail")
    ...
    detail: str
    def __init__(self, criterion: _Optional[str] = ..., value: _Optional[str] = ..., target: _Optional[str] = ..., as_of: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., detail: _Optional[str] = ..., **kwargs) -> None: ...
...
class JdSubmissionRow(_message.Message):
    __slots__ = ("id", "status", "match_score", "text_head", "role_hint", "employer_hint", "contact_email", "source", "error_message", "generated_resume_url", "created_at", "completed_at", "retrieval_score", "submitter_email", "apply_url")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    MATCH_SCORE_FIELD_NUMBER: _ClassVar[int]
